...
class ProventosAcaoFundamentusWsToGold:
    ...
    def get_dataframe(self):
        return IngestionController("fundamentus/proventos/acao").read_silver()
    
    
    def run(self):       
        IngestionController("fundamentus/proventos/acao") \
...
ProventosAcaoFundamentusWsToGold().run()